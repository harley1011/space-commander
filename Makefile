...
#
COMMON_OBJECTS = $(COMMON_BIN)/subsystems.o $(COMMON_BIN)/command-factory.o $(COMMON_BIN)/deletelog-command.o  $(COMMON_BIN)/decode-command.o $(COMMON_BIN)/getlog-command.o $(COMMON_BIN)/gettime-command.o $(COMMON_BIN)/reboot-command.o $(COMMON_BIN)/settime-command.o $(COMMON_BIN)/update-command.o $(COMMON_BIN)/timetag-command.o
...
#
UNIT_TEST = tests/unit/Net2Com-test.cpp  tests/unit/deletelog-command-test.cpp  tests/unit/getlog-command-test.cpp tests/unit/commander-test.cpp tests/unit/settime-command-test.cpp  tests/unit/gettime-command-test.cpp tests/unit/timetag-test.cpp
...
COMMON_Q6_OBJECTS = $(COMMON_Q6_BIN)/command-factoryQ6.o $(COMMON_Q6_BIN)/deletelog-commandQ6.o $(COMMON_Q6_BIN)/decode-commandQ6.o $(COMMON_Q6_BIN)/getlog-commandQ6.o $(COMMON_Q6_BIN)/gettime-commandQ6.o $(COMMON_Q6_BIN)/reboot-commandQ6.o $(COMMON_Q6_BIN)/settime-commandQ6.o $(COMMON_Q6_BIN)/update-commandQ6.o $(COMMON_Q6_BIN)/update-commandQ6.o $(COMMON_Q6_BIN)/subsystemsQ6.o 
